...
sections = [
    ...
    ("三、个人课程收获、思考和困惑", [
        ...
        "还有一个收获是，我开始愿意把中间过程写下来。以前做实验报告，总想直接写结果，觉得过程不重要。现在发现，数据从原始文件到最后结论，中间每一步都可能影响结果。比如为什么删重复，为什么保留某些字段，为什么不用另一个统计方式，这些如果不写清楚，别人其实很难判断我的结论是不是可靠。",
        ...
        "后面如果还有机会继续学，我想先把基础工具练熟一点。至少遇到数据表、日志文件或者简单的统计任务时，能自己把流程走完整，而不是只照着步骤做。这样再去理解更大的平台和框架，可能会更踏实。",
