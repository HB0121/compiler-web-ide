...
def main() -> int:
    ...
    assert_contains(assembly.texts["assembly"], ".MODEL SMALL", "masm model")
    assert_contains(assembly.texts["assembly"], "main PROC", "masm main")
    assert_contains(assembly.texts["assembly"], "fn_add PROC", "masm function")
    read_write = assert_no_diagnostics("05_assembly_masm16/assembly_read_write.c")
    assert_contains(read_write.texts["assembly"], "builtin read(): returns 0 in AX", "masm read")
    assert_contains(read_write.texts["assembly"], "builtin write(): value is already evaluated", "masm write")
