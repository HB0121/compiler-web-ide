...
def main() -> int:
    ...
    lexical_text = assert_no_diagnostics("01_lexical/lexical_comments_strings.c")
    ...
    nested = assert_no_diagnostics("02_syntax/syntax_nested_loops.c")
    ...
    assert_diagnostic_codes("03_semantic/semantic_return_type_error.c", {"307", "310"})
    ...
    array_sum = assert_no_diagnostics("04_ir_interpreter/interpreter_array_sum.c")
    ...
    recursive_asm = assert_no_diagnostics("05_assembly_masm16/assembly_recursive_factor.c")
    ...
    mixed_log = read_case("06_log_regex_automata/log_mixed_formats.log")
    ...
    llvm_mod = assert_no_diagnostics("07_llvm_ir/llvm_modulo_loop.c")
    ...
    complex_cfg_dag = assert_no_diagnostics("08_cfg_dag_optimization/cfg_dag_complex.c")
